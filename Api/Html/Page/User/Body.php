                            ...
                            <div class="p-card u-vertically-center">
                                ...
                                <div class="card">
                                    <table>
                                        ...
                                        <tr>
                                            <th>First Name</th>
                                            <th><?php echo \Api\Core\Context::get('user')->first_name; ?></th>
                                        </tr>
                                        <tr>
                                            <th>Last Name</th>
                                            <th><?php echo \Api\Core\Context::get('user')->last_name; ?></th>
                                        </tr>
                                        <tr>
                                            <th>Email</th>
                                            <th><?php echo \Api\Core\Context::get('user')->email; ?></th>
                                        </tr>
                                        <tr>
                                            <th>Created On</th>
                                            <th><?php
                                                echo is_null(\Api\Core\Context::get('user')->created_date)
                                                    ? ltrim(date("m/d/Y"), "0")
                                                    : (new DateTime(\Api\Core\Context::get('user')->created_date))->format("F j, Y"); ?></th>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="card">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo \Api\Core\Database\Database::config("rep_rest_default", \Api\Core\Context::get('user')->id) ?></th>
                                            <th>User Default</th>
                                        </tr>
                                        <tr>
                                            <th>Seconds Between Sets</th>
                                            <th><?php echo \Api\Core\Database\Database::config("set_rest_default", \Api\Core\Context::get('user')->id) ?></th>
                                            <th>User Default</th>
                                        </tr>
                                        <tr>
                                            <th>Workouts Pagination</th>
                                            <th><?php echo \Api\Core\Database\Database::config("pagination_default", \Api\Core\Context::get('user')->id) ?></th>
                                            <th>User Default</th>
                                        </tr>
                                        <tr>
                                            <th>Play Timer Sound</th>
                                            <th><?php echo \Api\Core\Database\Database::config("play_timer_sound", \Api\Core\Context::get('user')->id) ?></th>
                                            <th>User Default</th>
                                        </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="p-card u-vertically-center">
                                ...
                                <div class="card">
                                    <table>
                                        ...
                                        <tr>
                                            <th>Timezone</th>
                                            <th><?php echo \Api\Core\Database\Database::config("default_timezone", \Api\Core\Context::get('user')->id) ?></th>
        ...
        <form id="userSettingsForm" class="login__form">
            <div class="form-box card selected-login">
                <p class="u-clearfix">
                    ...
                    <input class="input login__input" autocapitalize="off" autocorrect="off" type="text" placeholder="First Name" value="<?php echo \Api\Core\Context::get('user')->first_name; ?>" name="first_name" />
                </p>
                <p class="u-clearfix">
                    <label class="login__title">Last Name</label>
                    <input class="input login__input" autocapitalize="off" autocorrect="off" type="text" placeholder="Last Name" value="<?php echo \Api\Core\Context::get('user')->last_name; ?>"  name="last_name" />
                </p>
                <p class="u-clearfix">
        ...
        <form id="workoutSettingsForm" class="login__form">
            <div class="form-box card selected-login">
                <p class="u-clearfix">
                    ...
                    <input class="input login__input" autocapitalize="off" autocorrect="off" type="text" placeholder="Reps (seconds)" value="<?php echo \Api\Core\Database\Database::config("rep_rest_default", \Api\Core\Context::get('user')->id) ?>" name="rep_rest_default" />
                </p>
                <p class="u-clearfix">
                    <label class="login__title">Seconds Between Sets:</label>
                    <input class="input login__input" autocapitalize="off" autocorrect="off" type="text" placeholder="Sets (seconds)" value="<?php echo \Api\Core\Database\Database::config("set_rest_default", \Api\Core\Context::get('user')->id) ?>"  name="set_rest_default" />
                </p>
                <p class="u-clearfix">
                    <label class="login__title">Workouts Pagination:</label>
                    <input class="input login__input" autocapitalize="off" autocorrect="off" type="text" placeholder="Pagination" value="<?php echo \Api\Core\Database\Database::config("pagination_default", \Api\Core\Context::get('user')->id) ?>"  name="pagination_default" />
                </p>
                <p class="u-clearfix">
                    <label class="login__title">Play Timer Sound:</label>
                    <input class="input login__input" autocapitalize="off" autocorrect="off" type="text" placeholder="Play Timer Sound" value="<?php echo \Api\Core\Database\Database::config("play_timer_sound", \Api\Core\Context::get('user')->id) ?>"  name="play_timer_sound" />
                </p>
                <p class="u-clearfix">
        ...
        <form id="systemSettingsForm" class="login__form">
            <div class="form-box card selected-login">
                <p class="u-clearfix">
                    ...
                    <input class="input login__input" autocapitalize="off" autocorrect="off" type="text" placeholder="Timezone" value="<?php echo \Api\Core\Database\Database::config("default_timezone", \Api\Core\Context::get('user')->id) ?>" name="default_timezone" />
                </p>
                <p class="u-clearfix">
