                ...
                <div class="u-float-left">
                    <a class="dash__link" href="/go">
                        ...
                        <button class="p-button--positive p-tooltip--top-center has-icon" aria-describedby="btm-cntr">
                            ...
                            <?php
                            $results = \Api\Core\Database\Database::execute('total-workouts.sql', [
                                'user_id' => \Api\Core\Context::get('user')->fields["id"]
                            ]);
                            $totalWorkouts = $results[0]['total'];
                            echo $totalWorkouts;
                            \Api\Core\Context::set('total-workouts', $totalWorkouts);
                            ?>
