        ...
        try {
            ...
            if (strcmp($web, "public_html") !== 0) {
                if (empty($_SERVER["DOCUMENT_ROOT"])) {
                    ...
                    // This call came from within this app project
                    $output = file_get_contents(
                        $path ?? dirname($_SERVER["DOCUMENT_ROOT"],1) . "/.env");
                }
            } else {
                // This call is from outside of the app project and came from the parent public_html application who uses this
